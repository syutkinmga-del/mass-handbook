...
const config: Config = {
  title: 'MASS Handbook',
  tagline: 'Справочник для разработчиков автономных морских судов',
  ...
  url: 'https://mass-handbook.vercel.app',
...
onBrokenMarkdownLinks: 'warn',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} MASS Handbook. Built with Docusaurus.`,
    },
    prism: {
